  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        {/* Imagem */}
        <Image
          source={require("../../assets/ms.jpg")} // Substitua pelo caminho correto da sua imagem
          style={styles.image}
        ...
        <Text style={styles.description}>
          Esta é uma descrição sobre o Rosto. Aqui você pode adicionar informações relevantes sobre o que está sendo mostrado na imagem.
        </Text>
      </View>
    </ScrollView>
  );
